...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name='Категория', on_delete=models.CASCADE) #удалить все связи
    ...
    def save(self,*args,**kwargs):
        ...
        if img.height < min_height or img.width < min_weight:
            raise MinResolutionErrorException("Загруженое ихображение меньше допустимого ")
